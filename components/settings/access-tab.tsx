...
const ROLE_HINT: Record<LoginRole, string> = {
  MEMBER: "Закрывают свои задачи, берут задачи на себя, прикрепляют ссылки, пишут идеи и голосуют.",
  LEAD: "Всё, что участники, плюс создают мероприятия, ставят даты, назначают задачи, ведут свои мероприятия, правят регламенты.",
